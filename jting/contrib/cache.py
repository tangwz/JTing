...
class Cache(object):
    def __init__(self, app, prefix='jting', **kwargs):
        # TODO: support select cache when init this object.
        self.prefix = prefix
        ...
        app.extensions[prefix.lower() + '_cache'] = self.cache
    ...
    def _config(self, key, default='error'):
        key = key.upper()
        prior = '%s_CACHE_%s' % (self.prefix, key)
...
if __name__ == '__main__':
    ...
    app = Flask(__name__)
    app.config['TEST_CACHE_TYPE'] = 'redis'
